...
🔹 ${tools.formatNumber(pair.twitter_info.friends_count)} Following | *${tools.formatNumber(pair.twitter_info.statuses_count)}* Tweets | ${tools.formatNumber(pair.twitter_info.favourites_count)} Fav`;
    }
